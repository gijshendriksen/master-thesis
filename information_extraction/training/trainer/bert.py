...
class BertTrainer(BaseTrainer):
    ...
    def forward(self, batch: BertBatch):
        input_embeddings = self.model.bert.get_input_embeddings()(batch.input_ids)
        input_embeddings += batch.ancestors.repeat(1, 1, 2)

        return self.model(
            input_embeds=input_embeddings.to(self.device),
